...
import {
  ...
  ShoppingCart,
  Receipt,
  Package, // Usado para Inventario
  Box, // Nuevo icono para Productos
  Truck,
  BarChart3,
  ShoppingBag,
  Settings,
...
const navItems = [
  ...
  { href: "/inventory", label: "Inventario", icon: Package }, // <--- AGREGADO AQUÍ
...
export default function Sidebar() {
  ...
  return (
    <aside className="w-72 bg-gray-800 border-r border-zinc-800 hidden lg:flex flex-col h-screen">
      {/* Logo */}
        ...
        <div className="space-y-1">
          ...
          <RoleGuard roles={["OWNER"]}>
            <div className="pt-6 mt-6 border-t border-white">
              ...
              <div className="space-y-1">
                {[
                  { href: "/products", label: "Productos", icon: Box }, // <--- ICONO ACTUALIZADO
                  { href: "/suppliers", label: "Proveedores", icon: Truck },
                  { href: "/purchases", label: "Compras", icon: ShoppingBag },
                  { href: "/expenses", label: "Gastos", icon: BadgeDollarSign },
